package com.plataforma.crpg.widgets
...
class BorderedCircle : View {
    ...
    private fun init(attrs: AttributeSet?) {
        if(attrs != null) {
            ...
            mFillColor = typedArray.getColor(R.styleable.BorderedCircle_fillColor, ContextCompat.getColor(context, R.color.white))
            mBorderColor = typedArray.getColor(R.styleable.BorderedCircle_borderColor, ContextCompat.getColor(context, R.color.colorBlack))
